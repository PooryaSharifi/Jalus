<div class="fixed w-full top-0 left-0 bg-neutral-000 z-4 shadow-1-bottom styles_BaseLayoutDesktop__header__L8zhh"
                      ...
                      <div class="flex items-center justify-between grow min-w-0 h-9">
                        <div class="flex cursor-pointer"><svg
                            ...
                            <use xlinkHref="#searchSearch">
                              <symbol id="searchSearch" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M10.5 18a7.5 7.5 0 115.973-2.963l4.369 4.246-1.394 1.434-4.387-4.263A7.467 7.467 0 0110.5 18zm5.5-7.5a5.5 5.5 0 11-11 0 5.5 5.5 0 0111 0z" clip-rule="evenodd"></path></symbol>
                            </use>
                                              ...
                                              <div class="flex items-center shrink-0 mr-4">
                                                <div class="flex cursor-pointer">
                                                  <svg style={{width: 24, height: 24, fill: 'var(--color-icon-high-emphasis)'}}>
                                                    ...
                                                    <symbol id="searchPlaceSuggest" viewBox="0 0 24 24"><path d="M17 8.414L6.707 18.707l-1.414-1.414L15.586 7H9V5h9a1 1 0 011 1v9h-2V8.414z"></path></symbol>
                                                    </use>
                                                  </svg>
                                                </div>
                                              </div>
          ...
          <div class="flex items-center justify-end">
            <a class="styles_Link__RMyqc" onClick={() => {if (this.state.session) {delCookie('phone'); delCookie('session'); this.setState({'phone': '', 'session': ''})} else this.setState({potent: true, potentInterest: ''}, () => {window.history.pushState({}, '')})}}>
              <button class="relative flex items-center user-select-none styles_btn__Q4MvL text-button-2 styles_btn--medium__4GoNC styles_btn--neutralOutlined__mLWvq styles_btn--black__xj6Mt rounded-medium whitespace-nowrap shrink-0 ml-2 lg:ml-0" data-cro-id="header-profile">
                <div class="flex items-center justify-center styles_btn__loading__d5Rcc"><svg width="24" height="24" id="e302pyQgejw1" viewBox="0 0 24 24" shape-rendering="geometricPrecision" text-rendering="geometricPrecision">
                ...
                <div class="flex items-center justify-center relative grow">
                  <div class="flex ml-2"><svg style={{width: 24, height: 24, fill: 'var(--color-icon-high-emphasis)'}}>
                      <use xlinkHref="#registerationSignIn">
                        <symbol id="registerationSignIn" viewBox="0 0 24 24">
            ...
            <div class="relative flex flex-col"><a
                ...
                <div class="flex"><svg style={{width: 24, height: 24, fill: 'var(--color-icon-high-emphasis)'}}>
                    <use xlinkHref="#cartOff">
                      <symbol id="cartOff" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M20 4h2V2h-3a1 1 0 00-1 1v1H3a1 1 0 00-.995 1.1l1 10A1 1 0 004 16h15a1 1 0 001-1V4zm-2 17a2 2 0 110-4 2 2 0 010 4zM5 21a2 2 0 110-4 2 2 0 010 4zm13-7V6H4.105l.8 8H18z" clip-rule="evenodd"></path></symbol>
                    </use>
                  </svg></div>
              </a>
              <div
                ...
                <div class="flex items-center py-2 px-3 border-complete-t"><a
                    ...
                    <div class="flex items-center justify-center styles_btn__loading__d5Rcc"><svg width="24" height="24"
                        id="e302pyQgejw1" viewBox="0 0 24 24"
        ...
        <div class="flex relative base-layout-desktop-header-navigation_BaseLayoutDesktopHeaderNavigation__navContainer__hGPBW">
          ...
          <div class="flex base-layout-desktop-header-navigation_BaseLayoutDesktopHeaderNavigation__navGroup__bGWtA">
            ...
            <div class="digikala-nav-item leading-0 h-full flex items-center px-2 px-3"><a
                ...
                data-cro-id="header-main-menu" href={this.state.page == 'strategist' ? '/strategist/takhmin' : "/main/dk-ds-gift-card/"}>
                <div class="flex ml-1 text-neutral-400"><svg
                    style={{width: 18, height: 18, fill: 'var(--color-icon-low-emphasis)'}}>
                    <use xlinkHref="#giftCard">
                      <symbol id="giftCard" viewBox="0 0 18 18"><path d="M11.25 10.5H15V12h-3.75v-1.5z"></path><path fill-rule="evenodd" d="M3 3h12a2.25 2.25 0 012.25 2.25v7.5A2.25 2.25 0 0115 15H3a2.25 2.25 0 01-2.25-2.25v-7.5A2.25 2.25 0 013 3zm0 1.5a.75.75 0 00-.75.75v7.5c0 .414.336.75.75.75h3v-2.69l-.97.97-1.06-1.06.988-.989A2.25 2.25 0 116 5.378V4.5H3zm3 3.75V7.5a.75.75 0 10-.75.75H6zm1.5-2.872V4.5H15a.75.75 0 01.75.75v7.5a.75.75 0 01-.75.75H7.5v-2.69l.97.97 1.06-1.06-.988-.989A2.25 2.25 0 107.5 5.378zm0 2.872h.75a.75.75 0 10-.75-.75v.75z" clip-rule="evenodd"></path></symbol>
                    </use>
                  </svg></div>{this.state.page == 'strategist' ? 'تخمین رتبه' : 'کارت هدیه'}
              </a></div>
            <div class="digikala-nav-item leading-0 h-full flex items-center px-2 px-3">
              <a class="flex whitespace-nowrap items-center cursor-pointer text-neutral-600 text-body-2"
                data-cro-id="header-main-menu" href={this.state.page == 'strategist' ? '/strategist/exam' : "/best-selling/"}>
                <div class="flex ml-1 text-neutral-400"><svg
                    style={{width: 18, height: 18, fill: 'var(--color-icon-low-emphasis)'}}>
                    <use xlinkHref="#searchTrend">
                      <symbol id="searchTrend" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M12.015 9.105c.222.397.41.73.466.842.361.724.519 1.31.519 2.053a2 2 0 01-4 0l.003-4.557c0-.953-1.206-1.367-1.79-.613C5.087 9.572 4 11.906 4 13.889 4 18.365 7.578 22 12 22c4.422 0 8-3.635 8-8.111 0-2.968-2.45-6.78-7.295-11.598a1 1 0 00-1.6.262c-.807 1.615-.807 3.28 0 4.894.178.356.582 1.076.91 1.658zM7 12a4 4 0 108 0c0-1.078-.238-1.962-.73-2.947-.079-.156-.31-.569-.566-1.024a50.532 50.532 0 01-.81-1.476c-.273-.546-.404-1.079-.393-1.612C16.18 8.811 18 11.834 18 13.889 18 17.267 15.31 20 12 20s-6-2.733-6-6.111c0-.87.33-1.925 1-3.154V12z" clip-rule="evenodd"></path></symbol>
                    </use>
          ...
          <div class="flex base-layout-desktop-header-navigation_BaseLayoutDesktopHeaderNavigation__navGroup__bGWtA">
            <div class="digikala-nav-item leading-0 h-full flex items-center px-2 px-3"><a
                ...
                href={this.state.page == 'strategist' ? '/strategist/exam' : "/faq/"}>{this.state.page == 'strategist' ? 'سوالات' : 'سوالی دارید؟'}</a></div>
            <div class="digikala-nav-item leading-0 h-full flex items-center px-2 px-3">
              <a class="flex whitespace-nowrap items-center cursor-pointer text-neutral-600 text-body-2" data-cro-id=""
                href={this.state.page == 'strategist' ? '/strategist/deev' : "/landings/seller-introduction/"}>{this.state.page == 'strategist' ? 'دیوسالاران' : 'در جالوس میزبانی کنید!'}</a></div>
          </div>
          <div
  ...
  {this.state.categoryShow && <div style={{position: 'absolute', overflow: 'hidden', width: 115, backgroundColor: 'white', borderRadius: 10, border: '1px solid #949494', marginTop: 3, marginRight: 35, boxShadow: '0 0 1px 1px #ededed'}}>
    ...
    {this.state.categories.map((c, ci) => <div class="touchable" style={{fontSize: '1.3rem', fontWeight: 400, lineHeight: 2.17, color: '#656971', paddingRight: 6}} onClick={async () => {if ('href' in c) window.location.href = c.href; if('action' in c) await c.action(); this.setState({category: ci, categoryShow: false})}}>{c.title}</div>)}
    ...
    {this.state.firstMenuList.map((c, ci) => <div class="touchable" style={{fontSize: '1.3rem', fontWeight: 400, lineHeight: 2.17, color: '#656971', paddingRight: 6}} onClick={async () => {if ('href' in c) window.location.href = c.href; if('action' in c) await c.action(); this.setState({firstMenuIndex: ci, firstMenuShow: false})}}>{c.title}</div>)}
    ...
    {this.state.secondMenuList.map((c, ci) => <div class="touchable" style={{fontSize: '1.3rem', fontWeight: 400, lineHeight: 2.17, color: '#656971', paddingRight: 6}} onClick={async () => {if ('href' in c) window.location.href = c.href; if('action' in c) await c.action(); this.setState({secondMenuIndex: ci, secondMenuShow: false})}}>{c.title}</div>)}
  </div>}
</div>