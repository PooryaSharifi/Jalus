  ...
  constructor(props) {super(props); let app = this; window.app = this;
    ...
    return <div>
      {this.state.potent ? ({/* #macro modules/potent */}) : (<>
        ...
        </div>} {this.state.swap >= 0 && <div class="ads-dialogue_box" id="swap" style={{marginBottom: 0, fontSize: '1.3em', position: 'fixed', bottom: 1, left: 80, right: 80, height: 222, overflow: 'hidden', background: '#ffff', borderRadius: 8, border: '1px solid grey', zIndex: 899}}>
        ...
        </div>} {this.state.match >= 0 && <div class="ads-dialogue_box" id="matches" style={{overflowX: 'hidden', fontSize: '1.3em', position: 'fixed', bottom: 1, left: 80, right: 80, height: 222, overflowY: 'scroll', background: '#ffff', borderRadius: 8, border: '1px solid grey', zIndex: 798}}>
