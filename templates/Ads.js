...
class App extends React.Component {
  constructor(props) {super(props); let app = this; window.app = this;
    this.state = {match: -1, swap: -1, swapLocation: '', swapQ: '', swapCategories: [['مغازه و دفتر', 'rent-office'], ['ویلا', 'buy-villa'], ['آپارتمان', 'buy-apartment'], ['اجاره ویلا', 'rent-villa'], ['اجاره آپارتمان', 'rent-apartment'], ['باغ و کلنگی', 'buy-old-house'], ['باغ و زمین', 'industrial-agricultural-property'], ['دلار،طلا', 'gold']], swapBudget: '', swapArea: '', swapCapacity: '', swapLiquidity: '', swapDebt: '', swapFill: [], 
    ...
    swapCategories: [['مغازه و دفتر', 'rent-office'], ['ویلا', 'buy-villa'], ['آپارتمان', 'buy-apartment'], ['اجاره ویلا', 'rent-villa'], ['اجاره آپارتمان', 'rent-apartment'], ['باغ و کلنگی', 'buy-old-house'], ['باغ و زمین', 'industrial-agricultural-property'], ['دلار،طلا', 'gold']]});
    ...
    return <div>
      {this.state.potent ? ({/* #macro modules/potent */}) : (<>
        ...
        {this.state.note >= 0 && <div id="notes" style={{fontSize: '1.3em', position: 'fixed', bottom: 1, left: 80, right: 80, height: 222, overflowY: 'scroll', background: '#ffff', borderRadius: 8, border: '1px solid grey', zIndex: 898}}>
          ...
          <div class="touchable" style={{fontSize: '1.3em', position: 'absolute', left: 67, bottom: 3, border: '1px solid #ea456e', padding: 3, paddingBottom: 0, paddingTop: 2, borderRadius: 6}} onClick={() => this.setState({swap: this.state.note, note: -1, swapCategories: [['مغازه و دفتر', 'rent-office'], ['ویلا', 'buy-villa'], ['آپارتمان', 'buy-apartment'], ['اجاره ویلا', 'rent-villa'], ['اجاره آپارتمان', 'rent-apartment'], ['باغ و کلنگی', 'buy-old-house'], ['باغ و زمین', 'industrial-agricultural-property']]})}>🔀</div>
          ...
          {this.state.ads.map((ad, adi) => <div class="touchable" style={{paddingTop: 10, paddingBottom: 5}} onClick={() => {console.log(ad.id); this.setState({show: ad})}}>
            ...
            <div class="narrow_fit_text" style={{textAlign: 'justify', display: 'inline-block', verticalAlign: 'top', position: 'relative'}}>
              ...
              <div class="narrow_sub" style={{width: '100%'}}>
                ...
                { (ad.swap || ad.matches) && <a style={{float: 'left', textDecoration: 'none', color: '#f43747', fontSize: '.85em', fontWeight: 500, cursor: 'pointer', paddingRight: 10, marginTop: -6}} onClick={(e) => {e.preventDefault(); e.stopPropagation(); e.nativeEvent.stopImmediatePropagation(); window.scrollTo({ top: window.scrollY + e.target.getBoundingClientRect().top - 342 }); this.setState({match: adi, note: -1})}}><span style={{backgroundColor: '#f43747', color: 'white', borderRadius: 10, width: 20, height: 20, display: 'inline-block', textAlign: 'center', verticalAlign: 'middle', marginRight: 5, lineHeight: '20px'}}>{ad.notes.length.farsify()}</span><span style={{fontSize: '1.6em', verticalAlign: 'middle'}}>🤝</span></a>}
